...
# Data Load
TotalsByCountry = pd.read_excel('spacelaunches.xlsx', sheet_name='TotalsByCountry')
TotalsByCountry.fillna(0, inplace=True)

TotalsByCountryYear = pd.read_excel('spacelaunches.xlsx', sheet_name='TotalsByCountryYear')
TotalsByCountryYear.fillna(0, inplace=True)

RawData = pd.read_excel('spacelaunches.xlsx', sheet_name='RawData')
